$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("src/test/java/com/brightE/featureFile/testScenario.feature");
formatter.feature({
